...
<body>
    ...
    <!--PR-->
    <form action="r_pr.php" method="post">
        <div id="main_bar" class="container-fluid">
            <div class="row">
                <div id="row_1" class="col-md-3">
                    บริษัท ไทยลอตเต้ จำกัด <br>
                    THAI LOTTE CO.,LTD. <br>
                    <img src="img\logo-lotte.jpg" alt="img\logo-lotte.jpg">
                </div /*--row1--*/>
                <div id="row_1" class="col-md-1">
                    ใบขอสั่งซื้อ <br><br>
                    Request
                </div /*--row1--*/>
                <div id="row_1" class="col-md-2">
                    เลขที่ใบขอสั่งซื้อ <br/>
                    Purchase No.
                    <br>
                    <input type="text" id="txtprnumber" name="txtprnumber">
                </div /*--row1--*/>
                <div id="row_1" class="col-md-3">
                    ผู้ขอซื้อ
                    Requester
                    <br><br>
                    <select id="slt_requester" name="slt_requester">
                            <?php while($row_user = mysqli_fetch_array($query_user)){ ?>
                                <option value="<?=$row_user['user_id']?>">
                                    <?=$row_user["user_email"];?>
                                </option>
                            <?php } ?>
                    </select>
                ...
                <div id="row_1" class="col-md-3">
                    ...
                    Department 
                    <br><br>
                    <select id="slt_department" name="slt_department" >
                            <?php while($row_department = mysqli_fetch_array($query_department)){ ?>
                                <option value="<?=$row_department['department_code']?>" >
                                    <?=$row_department["department_code"];?> <?=$row_department["department_name_en"];?>
                                </option>
                            <?php } ?>
                    </select>
                </div /*--row1--*/>
            ...
            <div class="row">            
                ...
                <div id="row_2" class="col-md-4">
                    รายละเอียด Description <br><br>
                    <input style="width: 420px; height: 90px;" type="text" id="txtdescription" name="txtdescription">
                </div /*--row-2--*/>
                <div id="row_2" class="col-md-5">
                    รหัสค่าใช้จ่าย Expense Code. <br><br><br>
            ...
            <div class="row">
                <div id="row_3" class="col-md-1" >
                    จำนวน Unit <br><br>
                    <input style="width: 40px;" type="text" id="txtunit" name="txtunit">
                </div /*--row-3--*/>
                <div id="row_3" class="col-md-2" >
                    สกุลเงิน Currency <br><br>
                ...
                <div id="row_3" class="col-md-2" >
                    จำนวนเงินประมาณ Total <br><br>
                    <input style="width: 200px;" type="text" id="txttotal" name="txttotal">
                </div /*--row-3--*/>
                <div id="row_3" class="col-md-3" >
                    วันที่ต้องการ Requirment Date <br><br>
                    <input style="width: 150px;" type="date" id="txtrequirmentdate" name="txtrequirmentdate">
                </div /*--row-3--*/>
                <div id="row_3" class="col-md-4" >
                    ชื่อผู้ใช้ User <br><br>
        ...
        </div /*--main_bar-container--*/>
    </form><!--action-r_pr.php-->
</body>
</html>